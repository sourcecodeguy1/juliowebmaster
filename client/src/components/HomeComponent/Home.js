...
import { ExternalLink, Github, ArrowRight, Linkedin } from 'lucide-react';
  ...
  <div className="bg-[#0a0a0f]">
    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          className="text-slate-500 max-w-xl mx-auto text-base leading-relaxed mb-8"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <a
            href="https://www.linkedin.com/in/julio-sandoval-webmaster/"
            target="_blank"
            rel="noreferrer"
            aria-label="LinkedIn"
          ...
          <a
            href="https://github.com/sourcecodeguy1"
            target="_blank"
            rel="noreferrer"
            aria-label="GitHub"
            className="text-slate-500 hover:text-indigo-400 transition-colors"
          ...
          <a
            href="https://www.upwork.com/freelancers/~015f1c1e4336c82348"
            target="_blank"
            rel="noreferrer"
            aria-label="Upwork"
            className="text-slate-500 hover:text-indigo-400 transition-colors"
